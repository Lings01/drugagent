...
- 🇬🇧 **English version**: [README.md](README.md) · [TUTORIAL.md](TUTORIAL.md)
- 📖 **使用教程（零基础 → 独立使用）**：[TUTORIAL.zh-CN.md](TUTORIAL.zh-CN.md)
...
`--vhh-dock-cdr-only`。完整参数表见 TUTORIAL.zh-CN §9。
...
├── README.md / TUTORIAL.md           # 英文主页 + 英文教程
├── README.zh-CN.md / TUTORIAL.zh-CN.md # 中文主页 + 中文教程
├── DESIGN.md                         # 2.0 架构设计
...
> 同属本地部署，重建方式见 [TUTORIAL.zh-CN.md](TUTORIAL.zh-CN.md) §1 与 HANDOFF.md）。
